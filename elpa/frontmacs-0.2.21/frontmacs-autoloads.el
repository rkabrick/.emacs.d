;;; frontmacs-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...

;;;### (autoloads nil "frontmacs-config" "frontmacs-config.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from frontmacs-config.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frontmacs-config" '("frontmacs-")))

;;;***

;;;### (autoloads nil "frontmacs-devel" "frontmacs-devel.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from frontmacs-devel.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frontmacs-devel" '("frontmacs")))

;;;***

;;;### (autoloads nil "frontmacs-keys" "frontmacs-keys.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from frontmacs-keys.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frontmacs-keys" '("frontmacs-kill-region-or-line")))

;;;***

;;;### (autoloads nil "frontmacs-ruby" "frontmacs-ruby.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from frontmacs-ruby.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frontmacs-ruby" '("frontmacs-ruby-mode-hook")))

;;;***

;;;### (autoloads nil "frontmacs-windowing" "frontmacs-windowing.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from frontmacs-windowing.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frontmacs-windowing" '("front")))

;;;***

;;;### (autoloads nil "vendor-frame-cmds" "vendor-frame-cmds.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from vendor-frame-cmds.el

(autoload 'save-frame-config "vendor-frame-cmds" "\
Save current frame configuration.
You can restore it with \\[jump-to-frame-config-register].

\(fn)" t nil)

(autoload 'jump-to-frame-config-register "vendor-frame-cmds" "\
Restore frame configuration saved in `frame-config-register'.

\(fn)" t nil)

(autoload 'deiconify-everything "vendor-frame-cmds" "\
Deiconify any iconified frames.

\(fn)" t nil)

(autoload 'iconify-everything "vendor-frame-cmds" "\
...
(autoload 'hide-everything "vendor-frame-cmds" "\
...
(autoload 'show-hide "vendor-frame-cmds" "\
...
(autoload 'show-buffer-menu "vendor-frame-cmds" "\
...
(autoload 'mouse-show-hide-mark-unmark "vendor-frame-cmds" "\
...
(autoload 'iconify/show-frame "vendor-frame-cmds" "\
...
(autoload 'mouse-iconify/show-frame "vendor-frame-cmds" "\
Iconify frame you click, if now shown.  Show it if now iconified.

\(fn EVENT)" t nil)

(autoload 'delete-windows-for "vendor-frame-cmds" "\
...
(autoload 'delete-windows-on "vendor-frame-cmds" "\
...
(autoload 'remove-windows-on "vendor-frame-cmds" "\
...
\(fn BUFFER &optional ALL-FRAMES)" t nil)

(autoload 'mouse-remove-window "vendor-frame-cmds" "\
Remove the window you click on.  (This calls `remove-window'.)
This command must be bound to a mouse click.

\(fn EVENT)" t nil)

(autoload 'delete/iconify-window "vendor-frame-cmds" "\
...
(autoload 'delete/iconify-windows-on "vendor-frame-cmds" "\
...
(autoload 'rename-frame "vendor-frame-cmds" "\
...
(autoload 'rename-non-minibuffer-frame "vendor-frame-cmds" "\
...
(autoload 'name-all-frames-numerically "vendor-frame-cmds" "\
...
(autoload 'name-frame-numerically "vendor-frame-cmds" "\
...
(autoload 'show-a-frame-on "vendor-frame-cmds" "\
...
(autoload 'show-*Help*-buffer "vendor-frame-cmds" "\
Raise a frame showing buffer *Help*, without selecting it.

\(fn)" t nil)

(autoload 'delete-1-window-frames-on "vendor-frame-cmds" "\
Delete all visible 1-window frames showing BUFFER.

\(fn BUFFER)" t nil)

(autoload 'delete-other-frames "vendor-frame-cmds" "\
...
(autoload 'maximize-frame-horizontally "vendor-frame-cmds" "\
Maximize selected frame horizontally.

\(fn &optional FRAME)" t nil)

(autoload 'maximize-frame-vertically "vendor-frame-cmds" "\
Maximize selected frame vertically.

\(fn &optional FRAME)" t nil)

(autoload 'maximize-frame "vendor-frame-cmds" "\
...
(autoload 'toggle-max-frame-horizontally "vendor-frame-cmds" "\
...
(autoload 'toggle-max-frame-vertically "vendor-frame-cmds" "\
...
(autoload 'toggle-max-frame "vendor-frame-cmds" "\
...
(autoload 'tile-frames-horizontally "vendor-frame-cmds" "\
...
(autoload 'tile-frames-vertically "vendor-frame-cmds" "\
...
(autoload 'create-frame-tiled-horizontally "vendor-frame-cmds" "\
Horizontally tile screen with selected frame and a copy.
The same character size is used for the new frame.

\(fn)" t nil)

(autoload 'create-frame-tiled-vertically "vendor-frame-cmds" "\
Vertically tile screen with selected frame and a copy.
The same character size is used for the new frame.

\(fn)" t nil)

(autoload 'split-frame-horizontally "vendor-frame-cmds" "\
...
(autoload 'split-frame-vertically "vendor-frame-cmds" "\
...
(autoload 'enlarge-frame "vendor-frame-cmds" "\
...
(autoload 'enlarge-frame-horizontally "vendor-frame-cmds" "\
...
(autoload 'shrink-frame "vendor-frame-cmds" "\
...
(autoload 'shrink-frame-horizontally "vendor-frame-cmds" "\
...
(autoload 'move-frame-down "vendor-frame-cmds" "\
...
(autoload 'move-frame-up "vendor-frame-cmds" "\
Move selected frame up.
Same as `move-frame-down', except movement is up.

\(fn &optional N FRAME)" t nil)

(autoload 'move-frame-right "vendor-frame-cmds" "\
...
(autoload 'move-frame-left "vendor-frame-cmds" "\
Move frame to the left.
Same as `move-frame-right', except movement is to the left.

\(fn &optional N FRAME)" t nil)

(autoload 'move-frame-to-screen-top "vendor-frame-cmds" "\
...
(autoload 'move-frame-to-screen-bottom "vendor-frame-cmds" "\
...
(autoload 'move-frame-to-screen-left "vendor-frame-cmds" "\
...
(autoload 'move-frame-to-screen-right "vendor-frame-cmds" "\
...
(autoload 'move-frame-to-screen-top-left "vendor-frame-cmds" "\
...
(autoload 'enlarge-font "vendor-frame-cmds" "\
...
(autoload 'set-frame-alist-parameter-from-frame "vendor-frame-cmds" "\
...
(autoload 'set-all-frame-alist-parameters-from-frame "vendor-frame-cmds" "\
...
(autoload 'tell-customize-var-has-changed "vendor-frame-cmds" "\
Tell Customize to recognize that VARIABLE has been set (changed).
VARIABLE is a symbol that names a user option.

\(fn VARIABLE)" t nil)

(autoload 'other-window-or-frame "vendor-frame-cmds" "\
`other-frame', if `one-window-p'; otherwise, `other-window'.

\(fn ARG)" t nil)

(autoload 'tear-off-window "vendor-frame-cmds" "\
...
(autoload 'tear-off-window-if-not-alone "vendor-frame-cmds" "\
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "vendor-frame-cmds" '("frame-" "frcmds-" "available-screen-pixel-bounds" "move-frame-wrap-within-display-flag" "enlarge-font-tries" "window-mgr-title-bar-pixel-height" "show-hide-show-function" "rename-frame-when-iconify-flag")))

;;;***

;;;### (autoloads nil "vendor-frame-fns" "vendor-frame-fns.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from vendor-frame-fns.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "vendor-frame-fns" '("frame" "flash-ding" "multi-window-frames-on" "1-window-frames-on" "read-frame" "get-" "distance" "window-coords")))

;;;***

;;;### (autoloads nil "vendor-zoom-frm" "vendor-zoom-frm.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from vendor-zoom-frm.el

(let ((loads (get 'zoom 'custom-loads))) (if (member '"vendor-zoom-frm" loads) nil (put 'zoom 'custom-loads (cons '"vendor-zoom-frm" loads))))
...
(custom-autoload 'frame-zoom-font-difference "vendor-zoom-frm" t)

(autoload 'zoom-frm-in "vendor-zoom-frm" "\
...
(autoload 'zoom-frm-out "vendor-zoom-frm" "\
...
(autoload 'zoom-frm-unzoom "vendor-zoom-frm" "\
Cancel zoom of FRAME.

\(fn &optional FRAME)" t nil)

(autoload 'toggle-zoom-frame "vendor-zoom-frm" "\
...
;;;***

;;;### (autoloads nil nil ("frontmacs-completion.el" "frontmacs-css.el"
;;;;;;  "frontmacs-editing.el" "frontmacs-javascript.el" "frontmacs-markdown.el"
;;;;;;  "frontmacs-modeline.el" "frontmacs-pkg.el" "frontmacs-projectile.el"
;;;;;;  "frontmacs-style.el" "frontmacs-system.el" "frontmacs-ui.el"
;;;;;;  "frontmacs-vcs.el" "frontmacs-web.el" "frontmacs-yaml.el"
;;;;;;  "frontmacs.el") (0 0 0 0))
...
;; coding: utf-8
;; End:
;;; frontmacs-autoloads.el ends here
